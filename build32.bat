...
xcopy /Y SDL2MinGw\SDL2_mixer-2.0.4\i686-w64-mingw32\include\SDL2\SDL_mixer.h SDL2MinGw\SDL2-2.0.14\i686-w64-mingw32\include\SDL2
:DontDown
...
set SDL2MinGw_mixer_Library="SDL2MinGw/SDL2_mixer-2.0.4/i686-w64-mingw32/lib/"
set SDL2MinGw_mixer_DLL="SDL2MinGw\SDL2_mixer-2.0.4\i686-w64-mingw32\bin\SDL2_Mixer.dll"
